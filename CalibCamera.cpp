...
//
//CalibCamera::CalibCamera(QWidget* parent, ImageCropper* const& cropper) : // constructor
//    QDialog(parent),
...
//}
//
//void CalibCamera::show_CalibDialog() {  // show
//    userPressDone = false;
//    setModal(true);
//    showFullScreen();
//}
//
//void CalibCamera::updateNewFrame(cv::Mat frame) {  // replace
//    frame.copyTo(calibFrame);
//    displayFrame();
//}
//
//void CalibCamera::dialogInit() { // init 
